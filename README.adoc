...
:page-description: Learn how to add manual instrumentation to collect custom tracing spans and custom metrics from microservices by using MicroProfile Telemetry and the Grafana stack.
